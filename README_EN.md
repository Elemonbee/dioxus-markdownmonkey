...
**Version 0.6.1** · English | **[中文](./README.md)**
...
- 📝 **Markdown Editing** - **CodeMirror 6** is the source of truth (line numbers / Markdown coloring / fenced-code highlighting / kernel undo / fold headings and code); live preview (tables / strikethrough / task lists / footnotes / **`$` math** / **Mermaid**, loaded on demand); click a preview block to jump to its source line; clickable task checkboxes in the editor; `/` snippets and `](` link completion; raw HTML and dangerous URLs are filtered; **syntax-highlighted preview code blocks**
...
Cross-platform packaging and tagging are documented in **[docs/RELEASE.md](docs/RELEASE.md)** (GitHub Actions: Windows zip + Setup.exe / Linux tar.gz + .deb / macOS `.app`). Complete **[docs/RELEASE_CHECKLIST.md](docs/RELEASE_CHECKLIST.md)** before tagging `v0.6.1`.
