...
**Version 0.6.4** · English | **[中文](./README.md)**
...
Cross-platform packaging and tagging are documented in **[docs/RELEASE.md](docs/RELEASE.md)** (GitHub Actions: Windows zip + Setup.exe / Linux tar.gz + .deb / macOS `.app`). Complete **[docs/RELEASE_CHECKLIST.md](docs/RELEASE_CHECKLIST.md)** before tagging `v0.6.4`.
