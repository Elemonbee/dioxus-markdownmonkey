# v0.5.0 打 tag 前验收清单 / Pre-tag checklist

打 `v0.5.0` 并推送到 GitHub 之前勾完本页。流程见 [RELEASE.md](RELEASE.md)。
Complete this page before tagging `v0.5.0`. See [RELEASE.md](RELEASE.md) for the publish flow.

## 文档 / Docs

- [x] `README.md` 与 `README_EN.md` 特性、技术栈、架构、目录结构一致
- [x] `Cargo.toml` 版本仍为 `0.5.0`，与 README / RELEASE 一致
